/*
  ZEBJUS FlightCore V18.3.25 - LOCAL Wi-Fi / mDNS + I2C PYTHON LAB
...
// ---------------- General ----------------
static const char* FW_VERSION="18.3.25";
...
struct ImuSample{uint8_t address=0,whoAmI=0;int16_t rawGx=0,rawGy=0,rawGz=0,rawAx=0,rawAy=0,rawAz=0;float gx=0,gy=0,gz=0,ax=0,ay=0,az=0;uint32_t sampledAt=0;};
...
void startNormalServer(){
  ...
  Serial.println("==============================");Serial.println("ZEBJUS FlightCore V18.3.25 LOCAL MODE");Serial.println("Controller: "+String(BOARD_NAME)+" ["+String(BOARD_ID)+"]");Serial.println("Device ID: "+deviceId);Serial.println("Kit Name : "+kitName);Serial.println("SSID     : "+WiFi.SSID());Serial.println("IP       : "+WiFi.localIP().toString());Serial.println("mDNS     : http://"+hostFromName(kitName)+".local");
}
void startSetupMode(){
...
void setup(){
  ...
  Serial.println("\n==============================\nZEBJUS FlightCore V18.3.25 LOCAL Wi-Fi + I2C\nBoard: "+String(BOARD_NAME)+" ["+String(BOARD_ID)+"]\nID: "+deviceId+"\n==============================");
