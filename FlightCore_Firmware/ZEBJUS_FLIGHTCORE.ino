/*
  ZEBJUS FlightCore V18.3.31 - LOCAL Wi-Fi / mDNS + I2C PYTHON LAB
...
// ---------------- General ----------------
static const char* FW_VERSION="18.3.31";
...
void startNormalServer(){
  ...
  Serial.println("==============================");Serial.println("ZEBJUS FlightCore V18.3.31 LOCAL MODE");Serial.println("Controller: "+String(BOARD_NAME)+" ["+String(BOARD_ID)+"]");Serial.println("Device ID: "+deviceId);Serial.println("Kit Name : "+kitName);Serial.println("SSID     : "+WiFi.SSID());Serial.println("IP       : "+WiFi.localIP().toString());Serial.println("mDNS     : http://"+hostFromName(kitName)+".local");
}
void startSetupMode(){
...
void setup(){
  ...
  Serial.println("\n==============================\nZEBJUS FlightCore V18.3.31 LOCAL Wi-Fi + I2C\nBoard: "+String(BOARD_NAME)+" ["+String(BOARD_ID)+"]\nID: "+deviceId+"\n==============================");
