...
void setupRoutes(){
  ...
  server.on("/",HTTP_GET,[](){if(setupMode)sendPortal();else statusApi();});server.on("/fly",HTTP_GET,sendFlyPage);server.on("/io",HTTP_GET,sendIoPage);
