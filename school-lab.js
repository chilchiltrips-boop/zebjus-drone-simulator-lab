...
function joystickKeys(){return window.zebjusGetKeyMap?.()||{pitchForward:'arrowup',pitchBack:'arrowdown',rollLeft:'arrowleft',rollRight:'arrowright',throttleUp:'w',throttleDown:'s',yawLeft:'a',yawRight:'d'}}
...
function joystickKeyUp(e){const k=e.key.toLowerCase();if(st.pythonRcActive||!st.joyKeys.has(k))return;st.joyKeys.delete(k);applyHeldJoystickKeys()}
