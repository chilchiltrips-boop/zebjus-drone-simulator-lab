...
http.createServer((req,res)=>{
 ...
 if(u.pathname==='/health'){res.writeHead(200,{'content-type':'application/json','cache-control':'no-store'});return res.end(JSON.stringify({ok:true,version:'18.3.25',mode:'static-local-kit'}))}
...
}).listen(PORT,'0.0.0.0',()=>console.log(`ZEBJUS FlightCore V18.3.25 static webapp: http://0.0.0.0:${PORT}`));
