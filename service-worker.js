const CACHE='zebjus-f450-v1751';const CORE=['./','./index.html','./styles.css','./app.js','./ui-runtime.js','./three.module.min.js','./fc_top_layout.png','./fc_board_reference.png','./icon-192.png','./icon-512.png'];
