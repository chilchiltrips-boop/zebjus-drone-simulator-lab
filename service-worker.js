const CACHE='zebjus-flightcore-v18-3-46';
const CORE=['./','./index.html','./styles.css','./app.js','./kit-local.js','./school-lab.js','./hardware-io.js','./ui-runtime.js','./firmware-updater.js','./python-worker.js','./python_companion/browser_cv2.py','./three.module.min.js','./glb-loader.js','./fc_top_layout.png','./fc_board_reference.png','./icon-192.png','./icon-512.png'];
